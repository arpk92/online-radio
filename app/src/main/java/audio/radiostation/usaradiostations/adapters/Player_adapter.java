...
public class Player_adapter extends RecyclerView.Adapter<Player_adapter.MyviewHolder> {
    ...
    Context context;
    public Player_adapter(FragmentActivity fragmentActivity, ArrayList<Model_class> mylist) {
    ...
    public MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View itemView = LayoutInflater.from( parent.getContext() )
                .inflate( R.layout.playerfragment, parent, false );

        return new Player_adapter.MyviewHolder( itemView );
    }


    @Override
    public void onBindViewHolder(@NonNull final Player_adapter.MyviewHolder holder, final int i) {
